...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        hubConnection.on("ReceiveGameState", (gameStateDto) -> {
            ...
            List<List<Integer>> objectStateList = new ArrayList<List<Integer>>();
            for (Map.Entry<String, List<Integer>> objectEntry : gameStateDto.getGameObjects().entrySet()) {
                ...
                objectStateList.add(objectEntry.getValue());
            }
            
            List<List<Integer>> playerStateList = new ArrayList<List<Integer>>();
            for (Map.Entry<String, List<Integer>> objectEntry : gameStateDto.getPlayerObjects().entrySet()) {
                ...
                playerStateList.add(objectEntry.getValue());
            }

            botService.setGameState(gameState, playerStateList, objectStateList);
        }, GameStateDto.class);
